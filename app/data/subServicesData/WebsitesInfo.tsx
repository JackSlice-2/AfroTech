export const WebsitesInfo = [
    {
       ...
       img: '/img/ComoUmSitePodeImpulsionarOSeuNegócio.jpg',
    },
    {
       ...
       img: '/img/VantagensDeUmSiteParaVendasOnline.png',
    },
    {
       ...
       img: '/img/ComoUmSitePodeAumentarACredibilidadeDaSuaMarca.png',
    },
    {
...
export const WebsitesText = {
   title: 'WebSites',
   description: 'Um site é uma plataforma online que apresenta informações sobre uma empresa, seus produtos ou serviços, e permite que os visitantes interajam com ela. Ele serve como um espaço para publicar conteúdo, conectar-se com novas pessoas, alcançar mais clientes e oferecer um canal para venda de produtos ou serviços. Ter um site traz benefícios significativos para as empresas, incluindo maior visibilidade no mercado, controle total sobre a plataforma, e a capacidade de operar 24 horas por dia, sem restrições físicas.'
 };