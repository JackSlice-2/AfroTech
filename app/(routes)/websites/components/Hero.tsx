...
const Hero = () => {
  return (
    <section className="h-screen  flex flex-col justify-between items-center">
      <Navbar />
      <div className="h-[110vh]  w-[1400px] flex justify-between mt-32">
      ...
      <div className="h-[110vh]  w-[1400px] flex justify-between mt-96 py-56  mb-20">
      ...
      <div className="h-[110vh]  w-[1400px] flex justify-between mt-16">
        <div className="flex flex-col justify-center -ml-52 mr-40 md:gap-10 md:flex-1 md:w-full md:items-center">
          <h1 className="text-6xl text-start md:text-40">
            &rdquo;Patience is Key When Troubleshooting.&rdquo;
          </h1>
